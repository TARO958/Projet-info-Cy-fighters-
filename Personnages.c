...
Personnages tab[NB_Personnages]={
    ...
    {.nom = "Evan",.type = "Guerrier",.point_de_vie_courante = 450 ,.point_de_vie_maximum =1000 ,.agi=0.5,.att =60,.vit = 85,.def = 0.1,.att_spe1=&spe[20],.att_spe2=&spe[7]},
    {.nom = "Enzo",.type = "Assassin",.point_de_vie_courante = 250 ,.point_de_vie_maximum =1000 ,.agi=0.5,.att =60,.vit = 95,.def = 0.5,.att_spe1=&spe[16],.att_spe2=&spe[21]},
};
void list_perso2(){
    int x;
    do{
