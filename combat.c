    ...
    do {
        ...
        switch(choix_action){
            case 1:
                ...
                break;
            case 2:
                select_adversaire_spe(attaquant,perso_select_joueur1,perso_select_joueur2);
                break;
            default :
                break;
        }
...
void select_adversaire_spe(Personnages *attaquant,Personnages *perso_select_joueur1[3],Personnages *perso_select_joueur2[3]){
    int x,y;
    if (attaquant==perso_select_joueur1[0] || attaquant==perso_select_joueur1[1] || attaquant==perso_select_joueur1[2]){
        do{
            choix_adversaire(attaquant,perso_select_joueur1,perso_select_joueur2,perso_select_joueur2);
