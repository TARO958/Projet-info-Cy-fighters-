...
Speciales tab[NB_ATT_SPE]={
    ...
    {.nom = "soin miraculeux ",.valeur = 25,.description = "géle l'adversaire" ,.nb_tours_actifs =1000 ,.nb_tours_rechargement},
    {.nom = "soin magique",.valeur = 25 ,.description = "tranche" ,.nb_tours_actifs =1000 ,.nb_tours_rechargement},
    {.nom = "protection",.valeur = 25,.description ="renforce la def du personnage de 35 % "   ,.nb_tours_actifs =1000 ,.nb_tours_rechargement},
    {.nom = "tourbillon",.valeur =25,.description = "tourne rapidement sur soi-même avec l'épée en main " ,.nb_tours_actifs =1000 ,.nb_tours_rechargement},
    ...
    {.nom = "smash",.valeur =25,.description = "infligle des dégats  sur trois adversaires" ,.nb_tours_actifs =1000 ,.nb_tours_rechargement},
    ...
    {.nom = "profonde entaille",.valeur =25 ,.description =  ,.nb_tours_actifs =1000 ,.nb_tours_rechargement},
};
